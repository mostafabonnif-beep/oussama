...
import com.dzhoof.iptv.presentation.ui.components.ChannelGridSkeleton
 ...
 * [com.dzhoof.iptv.presentation.ui.components.TvSearchKeyboard], so
    ...
    Surface(
        ...
        Row(
            ...
            if (query.isEmpty()) {
                ...
                Text(
                    text = stringResource(R.string.search_channels_content),
                    style = MaterialTheme.typography.bodyLarge,
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                    maxLines = 1
                )
